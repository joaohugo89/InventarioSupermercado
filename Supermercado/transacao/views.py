...
def compra_de_produtos(request):
    ...
    return render(request, "transacao/comprar.html", {"listProdutos": listProdutos, "nome_pagina": "Compra de produtos", "form": form})
...
def venda_de_produtos(request):
    ...
    return render(request, "transacao/vender.html", {"listProdutos": listProdutos, "nome_pagina": "Venda de produto", "form": form})
...
def relatorio_movimentacoes(request):
    ...
    return render(request, "transacao/listar_movimentacoes.html", {"listrelatorio": listrelatorio})